<?php
	...
	$str = ""; 
	$sql = "select * from tbl_status_master  where 1 ";
				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="status.php?mode=add"><font color="#FFFFFF">Add Status</font></a></span>
                            </div>
                        </div>
                    </div>
]
<div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="status_export_xl.php"><font color="#FFFFFF">Export Status</font></a></span>
                            </div>
                        </div>
                    </div>
...
<tr>
  ...
  <td><? echo getrecord("tbl_status1","name","where id='".$row['status']."'"); ?></td>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='status.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'status')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
