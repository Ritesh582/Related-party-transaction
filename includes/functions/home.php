...
//define the headers.
$headers = "From: gst@savvyonline.inrnReply-To: gst@savvyonline.in";
...
$attachments = chunk_split(base64_encode(file_get_contents('Bharti_AXA.pdf')));
