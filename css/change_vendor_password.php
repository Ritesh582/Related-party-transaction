	...
	if ($_POST['action'] == 'change_pwd'){
		...
		if($pwd_old == $_SESSION['pwd_tmp']){
			...
			//$showmsg = 'Password changed successfully!';
			 header("Location:index.php?err=gen");
	  exit;
		}else{
	  ...
	  <form  method="post"   class="form-horizontal" id="changePassword" >
                                ...
                                <div class="hr-line-dashed"></div>
								 <div class="form-group"><label class="col-sm-2 control-label">New Password</label>
                                    <div class="col-sm-10"> <input name="txtPassword" placeholder="Enter New Password" type='password' value="" class="form-control" required></div>
									
                                </div>
                                <div class="hr-line-dashed"></div>
								
								 <div class="form-group"><label class="col-sm-2 control-label">Confirm Password</label>
                                    <div class="col-sm-10"> <input name="txtconfirmPassword" id="txtPassword" placeholder="Enter Confirm Password" type='password' class="form-control" required></div>
