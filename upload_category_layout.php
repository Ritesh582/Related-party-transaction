                    ...
                    <div class="ibox float-e-margins">
                     ...
                     <div class="ibox-content">
						<?if($errmsg != ""){echo "<p class='error'>".$errmsg."<span>X</span></p>";}?>  
						     <form method="post" action="upload_category.php" class="form-horizontal" id="formGroup">
                                <div class="form-group"><label class="col-sm-2 control-label">omnibus categories</label>
                                    <div class="col-sm-10"><input type="text" placeholder="omnibus categories"  name='omnibus' value="<? echo $omnibus;?>"  class="form-control"></div>
                                ...
                                <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2">
		                               ...
		                               <input type='hidden' value='<?=$mode;?>' name='mode'>	
                                        <button class="btn btn-white" type="button" onclick="back_fn('upload_category_search.php');">Cancel</button>
