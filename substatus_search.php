				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="sub_status.php?mode=add"><font color="#FFFFFF">Add Substatus</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="substatus_export_xl.php"><font color="#FFFFFF">Export Substatus</font></a></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<tr>
  ...
  <!-- <td><? echo $row['substatus']; ?></td> -->

  <td><? echo getrecord("tbl_substatus1","name","where id='".$row['substatus']."'"); ?></td>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='sub_status.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'sub_status')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
