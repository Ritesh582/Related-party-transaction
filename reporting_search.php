<?php
	...
	$str = ""; 
	$sql = "select * from tbl_reporting_period_master  where 1 ";
				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="reporting.php?mode=add"><font color="#FFFFFF">Add Reporting</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="reporting_period_export_xl.php"><font color="#FFFFFF">export Reporting Period</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>List of reporting period</h5>
...
<? if($showmsg != ""){$class = 'success';if($_GET['msg'] == 'ndel'){$class = 'info';}echo "<p class='".$class."'>".$showmsg."<span>X</span></p>";}?>
  ...
  <th scope="col"><B>Reporting Period</B></th>
...
<tr>
  ...
  <td><? echo $row['reporting_period']; ?></td>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='reporting.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'reporting')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
