            ...
            if ($_POST['type'] == 'append') {
                ...
                if (count($data) == "1") {
                    ...
                    while (($data = @fgetcsv($handle, 3000, ',', '"')) != FALSE) {
                        ...
                        $insert_bank_statement = "INSERT INTO tbl_omnibus_subcategories_master(sub_category,comp_code,added_by,added_date) VALUES ('$sub_category','" . $_SESSION['comp_code_tmp'] . "','" . $_SESSION['admin_user_tmp'] . "','" . $added_date . "')";
...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Bulk upload omnibus subcategories</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>Bulk upload omnibus subcategories Details</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Bulk upload omnibus sub categories Entries</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for Bulk upload omnibus subcategories File Upload</font>
                                        </strong></td>
                                </tr>
                                <tr>
                            ...
                            <form name="form_bank_statement_excel_upload" method="post" action="upload_bulk_sub_category.php" enctype="multipart/form-data">
