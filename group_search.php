				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="group.php?mode=add"><font color="#FFFFFF">Add Group</font></a></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<? if($showmsg != ""){$class = 'success';if($_GET['msg'] == 'ndel'){$class = 'info';}echo "<p class='".$class."'>".$showmsg."<span>X</span></p>";}?>
  ...
  <th scope="col"><B>Group Code</B></th>
...
<tr>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='group.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'group')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
