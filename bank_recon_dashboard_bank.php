<?php
$pagename = 'bank_recon_dashboard_book_bank.php';
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>LIST OF  Bank Statements of <?= strtoupper($statusname)?></h5>
                                    ...
                                    <table id="dashboardTable" class="table table-striped table-bordered table-hover dataTables-example" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th  align="center" scope="col"><B>Amount</B></th>
			...
			$(document).ready(function() {
				...
				var dataTable = $('#dashboardTable').DataTable( {
					...
					"responsive": true,
						...
						url :"bank_recon_dashboard_status_data_bank.php?status="+<?=$_GET["status"]?>+"&mode="+mode+"&state_code="+state_code, // json datasource
