<?php
	...
	$str = ""; 
	$sql = "select * from tbl_account_oracle_master  where 1 ";
...
?>
     ...
     <? include "includes/sub-header.php";?>
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Upload Chart of Account-Oracle</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="main_dashboard.php">Home</a>
                            </li>
                            <li class="active">
                                <strong>Upload Chart of Account-Oracle</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="upload_oracle.php?mode=add"><font color="#FFFFFF">Add Oracle</font></a></span>
                            </div>
                        </div>                        
                    </div>
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="upload_bulk_sub_category.php"><font color="#FFFFFF">Upload  Oracle</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="account_oracle_export_xl.php"><font color="#FFFFFF">Export  Oracle</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="upload_update_account_oracle.php"><font color="#FFFFFF"> Updated  Oracle</font></a></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<? if($showmsg != ""){$class = 'success';if($_GET['msg'] == 'ndel'){$class = 'info';}echo "<p class='".$class."'>".$showmsg."<span>X</span></p>";}?>
  ...
  <th scope="col"><B>Account Oracle</B></th>
...
<tr>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='upload_oracle.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'upload_oracle')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
