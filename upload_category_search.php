<?php
	$pagename = 'upload_category_search.php';
	include ('includes/config.php');
	pageAccess((int)$_SESSION['admin_user_tmp']);
	include "includes/session_check.php";
	$showmsg = message($_GET['msg']);
	$str = ""; 
	$sql = "select * from  tbl_omnibus_categories_master where 1 ";
...
?>
     ...
     <? include "includes/sub-header.php";?>
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Omnibus Categories</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="main_dashboard.php">Home</a>
                            </li>
                            <li class="active">
                                <strong>Omnibus Categories</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="upload_category.php?mode=add"><font color="#FFFFFF">Add  Categories</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="upload_categories_bulk.php?mode=add"><font color="#FFFFFF">Upload  Categories</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="omnibus_categories_export_xl.php"><font color="#FFFFFF">Export Categories</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="bulk_upload_update_categories.php?mode=add"><font color="#FFFFFF"> Updated  Categories</font></a></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>List of Omnibus Categories</h5>
...
<tr>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='upload_category.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'upload_category')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
