...
<tr>
  ...
  <td><? echo yymmdd_ddmmyy($row['invoice_date']); ?></td>
  <td align="center"><?= $row['invoice_amount']; ?></td>
  <td> <?php 
	$condition = " where id ='".$row['vendor_id']."'";	
	echo getrecord('tbl_vendor_registration','business_name',$condition)
  ?></td>
  <td align="center"><?= getrecord('admin', 'name',"where admin_id='".$row["assign_checker_Id"]."'"); ?></td>
  <td align="center"><?= getrecord('tbl_sub_department', 'sub_dept_name',"where id='".$row["sub_dept_id"]."'"); ?></td>
  <td><? echo getrecord('tbl_rstatus','name', " where id = '". $row['status']."'"); ?></td>
  <td></td> 
</tr>
<? }?>                          
                  </tbody>
