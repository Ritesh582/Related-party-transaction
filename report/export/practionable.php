                ...
                <div class="wrapper wrapper-content animated fadeInRight">
				  <div class="ibox-content" >
							  ...
							  <div class="col-sm-10"> </div>
                                    <div class="col-sm-2"> 
									 <form  method='post' action='pr_report_export.php' target=_blank>
...
<? if($showmsg != ""){$class = 'success';if($_GET['msg'] == 'ndel'){$class = 'info';}echo "<p class='".$class."'>".$showmsg."<span>X</span></p>";}?>
  ...
  <th scope="col"><B>PR Requisition Cost</B></th>
  <th scope="col"><B>PR Checker Name</B></th>
  ...
  <th scope="col"><B>Status</B></th>
                  ...
                  <tbody>
					  ...
					  <tr>
						...
						<td><? echo $row['Prefix'].$row['requisition_no']; ?></td>
						<td><? echo yymmdd_ddmmyy($row['purchase_date']); ?></td>  
						<td><? echo $row['total_requisition_cost']; ?></td>
						<td><? echo getrecord('admin','name', " where admin_id = '". $row['assign_checker_Id']."'"); ?></td>
						<td><? echo getrecord('tbl_sub_department','sub_dept_name', " where id = '". $row['sub_dept_id']."'"); ?></td>
