                ...
                <div class="wrapper wrapper-content animated fadeInRight">
				  <div class="ibox-content" >
							  ...
							  <div class="col-sm-10"> </div>
                                    <div class="col-sm-2"> 
									 <form  method='post' action='report_export.php' target=_blank>
...
<? if($showmsg != ""){$class = 'success';if($_GET['msg'] == 'ndel'){$class = 'info';}echo "<p class='".$class."'>".$showmsg."<span>X</span></p>";}?>
  ...
  <th scope="col"><B>GSTIN</B></th>
  <th scope="col"><B>PAN NO</B></th>
  <th scope="col"><B>BUSINESS NAME</B></th>
  <th scope="col"><B>STATE JURISDICTION</B></th>
  <th scope="col"><B>DATE OF REGISTARTION</B></th>
  <th scope="col"><B>Approval No</B></th>
</tr>
                                        </thead>
                                        <tbody>
...
<tr>
 ...
 <td><? echo $row['Prefix'].$row['id']; ?></td>
  <td><? echo $row['gstin']; ?></td>
  ...
  ?></td>
       <td> <?php 
	$condition = " where branch_code ='".$row['upload_to_branch']."'";	
	echo getrecord('tbl_branch','name',$condition)
  ?></td>
  <td> <?php 
	$condition = " where branch_code ='".$row['state_jurisdiction']."'";	
	echo getrecord('tbl_branch','name',$condition)
  ?></td>
  <td><? echo yymmdd_ddmmyy($row['date_of_registration']); ?></td>
  <td><? echo $row['approvalNumber']; ?></td>
