                ...
                <div class="wrapper wrapper-content animated fadeInRight">
				  <div class="ibox-content" >
							  ...
							  <div class="col-sm-10"> </div>
                                    <div class="col-sm-2"> 
									 <form  method='post' action='po_report_export.php' target=_blank>
...
<tr>
  ...
  <td><? echo yymmdd_ddmmyy($row['po_date']); ?></td>  
  <td><? echo $row['cost']; ?></td>
  <td><?php 
	$condition = " where id ='".$row['vendor_id']."'";	
	echo getrecord('tbl_vendor','nameOfBusiness',$condition)
	  ?>
	  </td>
	<td>
            <?php  echo getrecord('tbl_expense_type','name', " where id = '". $row['expense_category']."'");
         ?></td>
        <td><?php echo getrecord('tbl_postatus','name', " where id = '". $row['po_status']."'"); ?></td>
  <td></td>
