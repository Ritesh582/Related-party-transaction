<?php
session_start();
$pagename = 'upload_update_account_fx.php';
            ...
            if ($_POST['type'] == 'append') {
                ...
                if (count($data) == "1") {
                    ...
                    while (($data = @fgetcsv($handle, 3000, ',', '"')) != FALSE) {
                        ...
                        $insert_bank_statement = "update  tbl_account_fx_master set  account_fx='".$account_fx."',comp_code='" . $_SESSION['comp_code_tmp'] . "',added_by='" . $_SESSION['admin_user_tmp'] . "',added_date='" . $added_date . "'";
...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Update Account-fx</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>Update Account-fx</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Update Account-fx Entries</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for  Update Account-fx File Upload</font>
                                        </strong></td>
                                </tr>
                                <tr>
                            ...
                            <form name="form_bank_statement_excel_upload" method="post" action="upload_update_account_fx.php" enctype="multipart/form-data">
