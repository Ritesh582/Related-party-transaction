<?php
session_start();
$pagename = 'upload_update_account_oracle.php';
            ...
            if ($_POST['type'] == 'append') {
                ...
                if (count($data) == "1") {
                    ...
                    while (($data = @fgetcsv($handle, 3000, ',', '"')) != FALSE) {
                        ...
                        $insert_bank_statement = "update tbl_account_oracle_master set  account_oracle='".$account_oracle."',comp_code='" . $_SESSION['comp_code_tmp'] . "',added_by='" . $_SESSION['admin_user_tmp'] . "',added_date='" . $added_date . "'";
...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Update account oracle</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>Update account oracle</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Update account oracle Entries</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for Update account oracle File Upload</font>
                                        </strong></td>
                                </tr>
                                <tr>
                            ...
                            <form name="form_bank_statement_excel_upload" method="post" action="upload_update_account_oracle.php" enctype="multipart/form-data">
