<?php
	...
	$str = ""; 
	$sql = "select * from tbl_frequency_master  where 1 ";
...
?>
     ...
     <? include "includes/sub-header.php";?>
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2> Processing Frequency </h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="main_dashboard.php">Home</a>
                            </li>
                            <li class="active">
                                <strong> Processing Frequency</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
				 ...
				 <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="frequency.php?mode=add"><font color="#FFFFFF">Add Frequency</font></a></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="label label-success pull-right"><a href="frequency_export_xl.php"><font color="#FFFFFF">Export Frequency</font></a></span>
                            </div>
                        </div>
                    </div>
...
<tr>
  ...
  <td><? echo getrecord("tbl_frequency","name","where id='".$row['frequency']."'"); ?></td>
 ...
 <td>
  ...
  <td width="45" align="center">
   ...
   <a  href='frequency.php?mode=edit&id=<?=$row['id'];?>'><i class="fa fa-pencil" aria-hidden="true"></i></a>
  <a href="#" onclick="deleterecord(<?=$row['id']?>,'frequency')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
