<?php
session_start();
$pagename = 'upload_categories_bulk.php';
            ...
            if ($_POST['type'] == 'append') {
                ...
                if (count($data) == "1") {
                    ...
                    while (($data = @fgetcsv($handle, 3000, ',', '"')) != FALSE) {
                        ...
                        $insert_bank_statement = "update  tbl_omnibus_categories_master set  omnibus='".$omnibus."',comp_code='" . $_SESSION['comp_code_tmp'] . "',added_by='" . $_SESSION['admin_user_tmp'] . "',added_date='" . $added_date . "'";
...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>update omnibus categories</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>update omnibus categories Details</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>update omnibus categories Entries</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for update omnibus categories File Upload</font>
                                        </strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align: center;">Update format</td>
                            ...
                            <form name="form_bank_statement_excel_upload" method="post" action="bulk_upload_update_categories.php" enctype="multipart/form-data">
                                ...
                                <table align="center" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="radio" name="type" value="append" checked="true" />Update&nbsp;&nbsp;</td>
                                        <td></td>
                                        <td>&nbsp;&nbsp;</td>
                                    </tr>
                                    <tr>
            ...
            if ($_POST['type'] == 'append') {
                ...
                if (count($data) == "1") {
                    ...
                    while (($data = @fgetcsv($handle, 3000, ',', '"')) != FALSE) {
                        ...
                        $insert_bank_statement = "INSERT INTO tbl_omnibus_categories_master(omnibus,comp_code,added_by,added_date) VALUES ('$omnibus','" . $_SESSION['comp_code_tmp'] . "','" . $_SESSION['admin_user_tmp'] . "','" . $added_date . "')";
                        // echo $insert_bank_statement;
                        // echo "<br/><br/>".$insert_bank_statement;
                        $res_query = mysql_query($insert_bank_statement);
...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Bulk update omnibus categories</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>Bulk update omnibus categories Details</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
        ...
        <div class="ibox-content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Bulk update omnibus categories Entries</h5>
                            <div class="ibox-tools">
                                <a class="collapse-link">
                                    <i class="fa fa-chevron-up"></i>
                                </a>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for Bulk upload omnibus categories File Update</font>
                                        </strong></td>
                                </tr>
                                <tr>
                                    <td colspan="4"><strong>1. Excel File should be in .csv format only.</strong></td>
                            ...
                            <form name="form_bank_statement_excel_upload" method="post" action="upload_categories_bulk.php" enctype="multipart/form-data">
                                <div style="display:none" id="progBar"><img src="img/progressbar.gif" /></div>
                                <table align="center" border="0">
