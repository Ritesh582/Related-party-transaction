...
<tr><th  width="730" align="center" colspan="14" bgcolor="#99CCFF"><h1>Tax Invoice</h1></th></tr>
 ...
 <tr><td  colspan="5" width="200">State:<? $state=getrecord('tbl_invoice_entry','place_of_supply','where invoice_id="'.$ft->Prefix."".$ft->id.'"');?>
 ...
 <tr><td  width="180" colspan="5">Add:SGST</td><td width="45" colspan="2"><?=$totalsgstAmt;?></td></tr>
  ...
  <tr><td  width="180" colspan="5">Total Amount after Tax</td><td width="45" colspan="2"><?=$totalAmt;?></td></tr>
	 ...
	 <tr><td  width="180" height="100" colspan="7" align="center"><img src="<? $signatureImage=getrecord('tbl_branch','signatureImage','where branch_code='.$ft->upload_to_branch.''); if($signatureImage!=""){echo DOMAIN."/".$imagePath.$signatureImage;}else{ echo DOMAIN."/img/15055504281505207536index.jpg";}?>" /><br /><?=getrecord('tbl_branch','authorityName','where branch_code='.$ft->upload_to_branch.'');?><br />Authorised Signatory</td></tr>
