...
<div id="page-wrapper" class="gray-bg">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Bulk upload omnibus categories</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="bank_recon_dashboard.php">Home</a>
                </li>
                <li class="active">
                    <strong>Bulk upload omnibus categories Details</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Bulk upload omnibus categories Entries</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <table align="center" border="0">
                                ...
                                <tr>
                                    <td colspan="4"><strong>
                                            <font size="4">Instruction for Bulk upload omnibus categories File Upload</font>
                                        </strong></td>
                                </tr>
                                <tr>
